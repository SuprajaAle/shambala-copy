...
const Navigation: React.FC<NavigationProps> = ({ currentRealm, realms }) => {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <nav className="fixed right-4 sm:right-6 lg:right-8 top-1/2 transform -translate-y-1/2 z-40 hidden sm:block">
      ...
      {/* Mobile Navigation */}
      <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-40 sm:hidden">
